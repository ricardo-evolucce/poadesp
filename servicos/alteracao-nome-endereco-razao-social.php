...
<head>
	<meta charset="utf-8">
	<title>Alterações de nome, endereço, razão social - PoaDesp</title>
	<!--fonts google-->
...
<body>
	...
	<section class="container jumbotron ">
		...
		<div class="row">
			<div class="col-12 col-md-7"><h1 class="display-4">Alterações de nome, endereço, razão social</h1> 
				<p class="lead texto-cinza">É importante manter o DetranRS atualizado quanto aos dados do proprietário do veículo para que os documentos contenham informações corretas.</p>
			...
			<div class="col-12 col-md-5 mt-2-m">
				<img src="../img/servicos/alteracao-nome-endereco-razao-social.jpg" class="img-fluid rounded">
			</div>
