...
<head>
	<meta charset="utf-8">
	<title>Vistoria prévia antes da compra - PoaDesp</title>
	<!--fonts google-->
...
<body>
	...
	<section class="container jumbotron ">
		...
		<div class="row">
			<div class="col-12 col-md-7"><h1 class="display-4">Vistoria prévia antes da compra</h1> 
				<p class="lead texto-cinza">O comprador de um seminovo poderá realizar uma vistoria prévia antes de concretizar a compra, para que alguns itens sejam checados e o comprador não tenha problemas futuros.</p>
			...
			<div class="col-12 col-md-5 mt-2-m">
				<img src="../img/servicos/vistoria-previa-antes-compra.jpg" class="img-fluid rounded">
			</div>
