...
<body>
	...
	<section class="container jumbotron ">
		...
		<div class="row">
			<div class="col-12 col-md-7"><h1 class="display-4">Impressao de CRV <br>digital</h1> 
				<p class="lead texto-cinza">Proprietários de veículos podem ter impresso o Certificado de Registro e Licenciamento do Veículo, documento que atesta que o veículo está licenciado para circular.</p>
			...
			<div class="col-12 col-md-5 mt-2-m">
				<img src="../img/servicos/impressao-crv-digital.jpg" class="img-fluid rounded">
			</div>
