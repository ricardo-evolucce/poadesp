...
<body>
	...
	<section class="container jumbotron ">
		...
		<div class="row">
			<div class="col-12 col-md-7"><h1 class="display-4">Transferência de propriedade</h1> 
				<p class="lead texto-cinza">A transferência de propriedade do veículo é o procedimento que deve ser feito quando um veículo troca de proprietário, seja por compra e venda, doação, herança, usucapião, aquisição em leilão ou outro motivo legal.</p>
			...
			<div class="col-12 col-md-5 mt-2-m">
				<img src="../img/servicos/transferencia-propriedade.jpg" class="img-fluid rounded">
			</div>
