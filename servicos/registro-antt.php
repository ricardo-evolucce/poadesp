...
<head>
	<meta charset="utf-8">
	<title>Registro ANTT - PoaDesp</title>
	<!--fonts google-->
...
<body>
	...
	<section class="container jumbotron ">
		...
		<div class="row">
			<div class="col-12 col-md-7"><h1 class="display-4">Registro ANTT</h1> 
				<p class="lead texto-cinza">Elaboração de procurações para venda e representação.</p>
				<hr class="my-4 cor-laranja">
				<p class="texto-cinza">Todos os veículos de carga que executem transporte rodoviário de carga mediante remuneração (veículos de categoria “aluguel” – placa de fundo vermelho e letras brancas), com capacidade de carga útil igual ou superior a 500 Kg.</p>
			...
			<div class="col-12 col-md-5 mt-2-m">
				<img src="../img/servicos/registro-antt.jpg" class="img-fluid rounded">
			</div>
