...
<head>
	<meta charset="utf-8">
	<title>Impressão da ATPV-e - PoaDesp</title>
	<!--fonts google-->
...
<body>
	...
	<section class="container jumbotron ">
		...
		<div class="row">
			<div class="col-12 col-md-7"><h1 class="display-4">Impressão da ATPV-e</h1> 
				<p class="lead texto-cinza">Autorização para transferência</p>
				<hr class="my-4 cor-laranja">
				<p class="texto-cinza">Os veículos registrados (primeiro emplacamento) ou que sofreram alteração no registro (transferência de propriedade, alteração de características, de dados, etc) a partir de 04 de janeiro de 2021, que recebem o documento que certifica a propriedade do veículo integrado ao documento de licenciamento anual unicamente no formato digital, deverão solicitar a impressão da Autorização para Transferência de Propriedade do Veículo em meio digital (ATPV-e) quando efetivamente for definida uma iminente mudança de proprietário.
			...
			<div class="col-12 col-md-5 mt-2-m">
				<img src="../img/servicos/impressao-atpv-e.jpg" class="img-fluid rounded">
			</div>
