...
<body>
	...
	<section class="container jumbotron ">
		...
		<div class="row">
			<div class="col-12 col-md-7"><h1 class="display-4">Primeiro emplacamento</h1> 
				<p class="lead texto-cinza">O primeiro emplacamento do veículo é o processo que tem como objetivo o registro inicial de um veículo junto ao DetranRS.</p>
			...
			<div class="col-12 col-md-5 mt-2-m">
				<img src="../img/servicos/primeiro-emplacamento.jpg" class="img-fluid rounded">
			</div>
		...
		<div class="container-fluid logo-redes">
			<div class="row align-items-center">
				...
				<div class="col col-md-4 offset-md-4 text-center ">
					...
					<a href="https://api.whatsapp.com/send?phone=5551999113632" class="fa fa-facebook" style="font-size:25px;"></a>
