...
<head>
	<meta charset="utf-8">
	<title>Vistoria GNV - PoaDesp</title>
	<!--fonts google-->
...
<body>
	...
	<section class="container jumbotron ">
		...
		<div class="row">
			<div class="col-12 col-md-7"><h1 class="display-4">Vistoria GNV</h1> 
			...
			<div class="col-12 col-md-5 mt-2-m">
				<img src="../img/servicos/vistoria-gnv.jpg" class="img-fluid rounded">
			</div>
