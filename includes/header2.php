					...
					<ul class="navbar-nav nav-fill w-100 align-items-start">
						...
						<li class="nav-item dropdown">
							...
							<div class="dropdown-menu">
								<a class="dropdown-item" href="primeiro-emplacamento.php">Primeiro emplacamento</a>
								<a class="dropdown-item" href="transferencia-propriedade.php">Transferência de propriedade</a>
								<a class="dropdown-item" href="comunicacao-de-venda.php">Comunicação de venda</a>
								<a class="dropdown-item" href="impressao-crv-digital.php">Impressão de CRV digital</a>
								<a class="dropdown-item" href="troca-municipio-estado.php">Troca de município e de estado</a>
								<a class="dropdown-item" href="troca-placa.php">Troca de placa</a>
								<a class="dropdown-item" href="segunda-via-crv.php">Segunda via CRV</a>
								<a class="dropdown-item" href="vistoria-gnv.php">Vistoria para GNV</a>
								<a class="dropdown-item" href="vistoria-previa-antes-compra.php">Vistoria prévia antes da compra</a>
								<a class="dropdown-item" href="elaboracao-procuracoes.php">Elaboração de procurações</a>
								<a class="dropdown-item" href="consulta-veiculos-deposito.php">Consulta de veículos em depósito</a>
								<a class="dropdown-item" href="liberacao-veiculos-deposito.php">Liberação de veículos em depósito</a>
								...
								<a class="dropdown-item" href="alteracao-nome-endereco-razao-social.php">Alterações de nome, endereço, razão social</a>
